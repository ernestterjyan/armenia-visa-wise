...
const TripInputSection = ({ trips, onAddTrip, onRemoveTrip, onClearAll, plannedEntry, onPlannedEntryChange, onCalculate }: Props) => {
  ...
  const handleAdd = () => {
    if (!pastEntry || !pastExit) {
      setError("Խնdelays\u053D\u0576\u0564\u0580\u0578\u0582\u0574 \u0565\u0576\u0584 \u056C\u0580\u0561\u0581\u0576\u0565\u056C \u0565\u0580\u056F\u0578\u0582 \u0561\u0574\u057D\u0561\u0569\u056B\u057E\u0568\u0589");
      return;
    }
    const entryDate = new Date(pastEntry + "T00:00:00");
    const exitDate = new Date(pastExit + "T00:00:00");
    if (exitDate < entryDate) {
      setError("Delays\u0535\u056C\u0584\u056B \u0561\u0574\u057D\u0561\u0569\u056B\u057E\u0568 \u0579\u056B \u056F\u0561\u0580\u0578\u0572 \u0574\u0578\u0582\u057F\u0584\u056B\u0581 \u0577\u0578\u0582\u057F \u056C\u056B\u0576\u0565\u056C\u0589");
      return;
    }
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-3xl bg-card border border-border p-6 md:p-8" style={{ boxShadow: "var(--shadow-card)" }}>
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="text-lg font-bold text-foreground">{"Delays\u054A\u056C\u0561\u0576\u0561\u057E\u0578\u0580\u057E\u0561\u056E \u0574\u0578\u0582\u057F\u0584\u056B \u0585\u0580\u0568"}</h2>
            <p className="text-xs text-muted-foreground">{"Delays\u0535\u0580\u0562 \u0565\u0584 \u0576\u0561\u056D\u0561\u057F\u0565\u057D\u0578\u0582\u0574 \u0574\u0578\u0582\u057F\u0584 \u0563\u0578\u0580\u056E\u0565\u056C"}</p>
          </div>
        </div>
        <input
          type="date"
      ...
      <div className="rounded-3xl bg-card border border-border p-6 md:p-8" style={{ boxShadow: "var(--shadow-card)" }}>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-bold text-foreground">{"Delays\u0546\u0561\u056D\u0578\u0580\u0564 \u0578\u0582\u0572\u0587\u0578\u0580\u0578\u0582\u0569\u0575\u0578\u0582\u0576\u0576\u0565\u0580"}</h2>
          {trips.length > 0 && (
            <button
              onClick={() => {
                if (confirm("Delays\u054E\u057D\u057F\u0561\u055E\u0570 \u0565\u0584, \u0578\u0580 \u0578\u0582\u0566\u0578\u0582\u0574 \u0565\u0584 \u057B\u0576\u057B\u0565\u056C \u0562\u0578\u056C\u0578\u0580\u0568\u0589")) onClearAll();
              }}
              ...
              <div key={i} className="flex items-center justify-between gap-3 rounded-2xl bg-muted/40 px-4 py-3 group">
                <div className="min-w-0">
                  ...
                  <div className="text-xs text-muted-foreground mt-0.5">
                    {diffDaysInclusive(trip.entry, trip.exit)} {"Delays\u0585\u0580"}
                  </div>
                </div>
                <button
        ...
        {showForm ? (
          <div className="rounded-2xl border border-border bg-muted/20 p-4">
            <div className="grid grid-cols-2 gap-3 mb-3">
              <div>
                <label className="text-xs font-semibold text-muted-foreground mb-1 block">{"Delays\u0544\u0578\u0582\u057F\u0584"}</label>
              ...
              <div>
                <label className="text-xs font-semibold text-muted-foreground mb-1 block">{"Delays\u0535\u056C\u0584"}</label>
