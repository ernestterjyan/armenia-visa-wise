  ...
  if (!hasPlannedDate) {
    return (
      <div className="rounded-3xl bg-card border border-border p-8 md:p-10 text-center" style={{ boxShadow: "var(--shadow-card)" }}>
        ...
        <h2 className="text-xl font-bold text-foreground mb-2">{"\u0538\u0576\u057F\u0580\u0565\u0584 \u0576\u0561\u056D\u0561\u057F\u0565\u057D\u057E\u0561\u056E \u0574\u0578\u0582\u057F\u0584\u056B \u0585\u0580\u0568"}</h2>
        <p className="text-muted-foreground text-sm max-w-sm mx-auto">
          {"\u0531\u057E\u0565\u056C\u0561\u0581\u0580\u0565\u0584 \u0576\u0561\u056D\u0578\u0580\u0564 \u0578\u0582\u0572\u0587\u0578\u0580\u0578\u0582\u0569\u0575\u0578\u0582\u0576\u0576\u0565\u0580\u0568 \u0587 \u0568\u0576\u057F\u0580\u0565\u0584 \u0574\u0578\u0582\u057F\u0584\u056B \u0585\u0580\u0568\u055D \u0561\u0580\u0564\u0575\u0578\u0582\u0576\u0584\u0568 \u057F\u0565\u057D\u0576\u0565\u056C\u0578\u0582 \u0570\u0561\u0574\u0561\u0580\u0589"}
        </p>
      </div>
    );
  }
  ...
  if (!result) {
    return (
      <div className="rounded-3xl bg-card border border-border p-8 md:p-10 text-center" style={{ boxShadow: "var(--shadow-card)" }}>
        ...
        <h2 className="text-xl font-bold text-foreground mb-2">{"\u054D\u0565\u0572\u0574\u0565\u0584 \u0570\u0561\u0577\u057E\u0565\u056C\u0568"}</h2>
        <p className="text-muted-foreground text-sm max-w-sm mx-auto">
          {"\u054D\u0565\u0572\u0574\u0565\u0584 \u00AB\u0540\u0561\u0577\u057E\u0565\u056C\u00BB \u056F\u0578\u0573\u0561\u056F\u0568\u055D \u057F\u0565\u057D\u0576\u0565\u056C\u0578\u0582 \u0569\u0565 \u0584\u0561\u0576\u056B \u0585\u0580 \u056F\u0561\u0580\u0578\u0572 \u0565\u0584 \u0574\u0576\u0561\u056C\u0589"}
        </p>
        {dashboard.usedBefore !== null && (
          <div className="mt-6 inline-flex items-center gap-3 rounded-2xl bg-muted/60 px-5 py-3">
            <span className="text-sm text-muted-foreground">{"\u0531\u0580\u0564\u0565\u0576 \u0585\u0563\u057F\u0561\u0563\u0578\u0580\u056E\u057E\u0561\u056E\u055D"}</span>
      ...
      <div className="flex items-start gap-4 mb-6">
        ...
        <div>
          ...
          <p className={`text-sm mt-1 ${isSuccess ? "text-success-foreground/80" : "text-error-foreground/80"}`}>
            {isSuccess
              ? `${"\u053F\u0561\u0580\u0578\u0572 \u0565\u0584 \u0574\u0576\u0561\u056C \u0561\u057C\u0561\u057E\u0565\u056C\u0561\u0563\u0578\u0582\u0575\u0576\u0568 "}${result.maxDays}${" \u0585\u0580\u0589"}`
              : "\u054E\u0565\u0580\u057B\u056B\u0576 180 \u0585\u0580\u057E\u0561 \u0574\u0565\u057B \u0561\u0580\u0564\u0565\u0576 \u0585\u0563\u057F\u0561\u0563\u0578\u0580\u056E\u0565\u056C \u0565\u0584 \u0561\u057F\u0561\u0574\u0561\u0576 \u0585\u0580\u0565\u0580 \u0576\u0578\u0580 stay-\u056B \u0570\u0561\u0574\u0561\u0580\u0589"
            }
          </p>
        </div>
      </div>
      ...
      {isSuccess ? (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="rounded-2xl bg-card/70 border border-border/40 p-4 text-center">
            ...
            <div className="text-xs text-muted-foreground mt-1">{"\u0540\u0576\u0561\u0580\u0561\u057E\u0578\u0580 \u0585\u0580\u0565\u0580"}</div>
          </div>
          <div className="rounded-2xl bg-card/70 border border-border/40 p-4 text-center">
            <div className="text-2xl font-extrabold text-foreground">
              {result.lastAllowedDate && formatDateStr(result.lastAllowedDate)}
            </div>
            <div className="text-xs text-muted-foreground mt-1">{"\u054E\u0565\u0580\u057B\u056B\u0576 \u0585\u0580\u0568"}</div>
          </div>
          <div className="rounded-2xl bg-card/70 border border-border/40 p-4 text-center">
            <div className="text-2xl font-extrabold text-foreground">{result.usedOnLastAllowed}/90</div>
            <div className="text-xs text-muted-foreground mt-1">{"\u0555\u0563\u057F\u0561\u0563\u0578\u0580\u056E\u057E\u0561\u056E"}</div>
          </div>
        </div>
      ) : (
        <div className="rounded-2xl bg-card/70 border border-border/40 p-4 text-center">
          <div className="text-2xl font-extrabold text-foreground">{result.usedBefore}/90</div>
          <div className="text-xs text-muted-foreground mt-1">{"\u0531\u0580\u0564\u0565\u0576 \u0585\u0563\u057F\u0561\u0563\u0578\u0580\u056E\u057E\u0561\u056E \u0585\u0580\u0565\u0580"}</div>
        </div>
      )}
    </div>
  );
