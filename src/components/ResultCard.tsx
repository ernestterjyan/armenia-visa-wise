          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-7 text-muted-foreground">
                {"\u0531\u0575\u057D \u057A\u0561\u0576\u0565\u056C\u0568 \u0564\u0561\u057C\u0576\u0578\u0582\u0574 \u0567 \u0571\u0565\u0580 \u0574\u0578\u0582\u057F\u0584\u056B \u0561\u0574\u0565\u0576\u0561\u056F\u0561\u0580\u0587\u0578\u0580 \u057A\u0561\u057F\u056F\u0565\u0580\u0568. \u0576\u0577\u0565\u0584 \u0585\u0580\u0568 \u0587 \u0561\u0576\u0574\u056B\u057B\u0561\u057A\u0565\u057D \u056F\u057F\u0565\u057D\u0576\u0565\u0584 \u0576\u0561\u0587 \u0561\u0575\u056C \u057F\u0561\u0580\u0562\u0565\u0580\u0561\u056F\u0576\u0565\u0580\u0589"}
              </p>
            </div>
          </div>
          <div className="rounded-lg border border-border bg-secondary px-4 py-4">
            <p className="text-sm text-muted-foreground">{"90 \u0585\u0580 / 180 \u0585\u0580"}</p>
            <p className="mt-2 text-sm leading-6 text-foreground">
              {"\u054D\u057F\u0578\u0582\u0563\u0578\u0582\u0574\u0568 \u0561\u0580\u057E\u0578\u0582\u0574 \u0567 \u057A\u056C\u0561\u0576\u0561\u057E\u0578\u0580\u057E\u0561\u056E \u0574\u0578\u0582\u057F\u0584\u056B \u0585\u0580\u057E\u0561\u0576 \u0576\u0561\u056D\u0578\u0580\u0564 179 \u0585\u0580\u0565\u0580\u0568\u0589"}
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.15fr)_360px]">
        <div>
          ...
          <div className="mt-5 flex items-end gap-3">
            <span className="font-mono text-6xl font-semibold leading-none tracking-[-0.08em] text-foreground md:text-8xl">
          ...
          <div className="mt-6">
            <div className="flex items-center justify-between text-sm">
              <span className="text-muted-foreground">{"\u0555\u0563\u057F\u0561\u0563\u0578\u0580\u056E\u057E\u0561\u056E \u0584\u0578\u057F\u0561"}</span>
              <span className="font-mono text-foreground">{result.usedBefore} / 90</span>
            </div>
            <div className="mt-2 h-3 overflow-hidden rounded-sm bg-card/60">
              <div
                className={`h-full rounded-sm ${isSuccess ? "bg-primary" : "bg-destructive"}`}
                style={{ width: `${Math.min(100, (result.usedBefore / 90) * 100)}%` }}
              />
            </div>
          </div>
        </div>
